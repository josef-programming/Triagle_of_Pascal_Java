...
To initialise a variable means:
- first time assignment of a value to a variable

If a variable is declared and initialised, it means the variable is defined.
